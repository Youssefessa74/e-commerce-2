                        ...
                        <div class="tab-pane active" id="signin-2" role="tabpanel" aria-labelledby="signin-tab-2">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="singin-email-2" name="email" value="{{ old('email') }}" required autofocus>
                                    @error('email')
                        ...
                        <div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="register-name" name="name" value="{{ old('name') }}" required autofocus>
                                    @error('name')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div><!-- End .form-group -->
                                ...
                                <div class="form-footer">
                                    ...
                                    <div class="mt-2">
                                        <a href="{{ route('login') }}" class="text-sm">Already registered? Log in</a>
                                    </div>
                                </div><!-- End .form-footer -->
                            </form>
                            <div class="form-choice">
